  ...
  return (
    <>
        ...
        <div className="group flex flex-wrap gap-4 mt-4 w-max">
          {nowPlayingMovies.length > 0
            ? nowPlayingMovies.map((movie) => (
                ...
                >
                  <div className="relative rounded-lg overflow-hidden h-49">
                    <img
                  ...
                  {selectedMovie === movie.id && (
                    <div className="absolute right-2 top-2 flex items-center justify-center bg-primary h-6 w-6 rounded">
                      <CheckIcon
            ...
            : [...Array(8)].map((_, idx) => (
                <MovieSkeleton key={idx} width={200} />
              ))}
        </div>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="inline-flex items-center gap-2 border border-primary/20 px-3 py-2 rounded-md mt-2 bg-primary/10">
